  ...
  return(
    <View style={styles.container}> 
      ...
      <View style={styles.incident}>
        ...
        <Text style={styles.incidentValeu}>{incident.name} de {incident.city}/{incident.uf}</Text>

        <Text style={styles.incidentProperty}>CASO:</Text>
        <Text style={styles.incidentValeu}>{incident.title}</Text>

        <Text style={styles.incidentProperty}>VALOR:</Text>
        <Text style={styles.incidentValeu}>{incident.value}</Text>
      </View>
